...
encode_labels = ['city','gender', 'relevent_experience', 'enrolled_university', 'education_level',
...
if method == 'one_hot':
    ...
    encode_labels = ['gender', 'relevent_experience', 'enrolled_university', 'education_level',
                'major_discipline', 'experience', 'company_size', 'company_type', 'last_new_job']
